		...
		<>
			...
			<ChatRoom>
				<ChatReceive>
					<ChatUserProfile />
					<ChatUserText>
						Lorem ipsum dolor sit, amet consectetur adipisicing elit. Ad aliquid eveniet libero placeat sequi adipisci
						consequuntur impedit? Eos autem provident quae ab similique, quibusdam incidunt ipsa perspiciatis?
						Obcaecati, animi libero!
					</ChatUserText>
				...
				<Reply>
					<ReplyInputImage />
					<ReplyInputText value={input} onChange={handleCheckValid} type="text" placeholder="메세지 입력하기..." />
